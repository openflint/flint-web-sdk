...
var FlintSenderManager, FlintSenderManagerFirefox,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

FlintSenderManager = require('../FlintSenderManager');

FlintSenderManagerFirefox = (function(_super) {
  __extends(FlintSenderManagerFirefox, _super);

  function FlintSenderManagerFirefox(options) {
    this.options = options;
    FlintSenderManagerFirefox.__super__.constructor.call(this, options);
  }

  FlintSenderManagerFirefox.prototype._createXhr = function() {
    return new XMLHttpRequest();
  };

  return FlintSenderManagerFirefox;

})(FlintSenderManager);

module.exports = FlintSenderManagerFirefox;



},{"../FlintSenderManager":11}],15:[function(require,module,exports){
window.FlintSenderManager = require('./FlintSenderManagerFirefox');



},{"./FlintSenderManagerFirefox":14}],16:[function(require,module,exports){
'use strict';
