...
var FlintDeviceScanner, FlintDeviceScannerFfos, SSDPManagerFfos,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
FlintDeviceScannerFfos = (function(_super) {
  var INTERVAL;

  __extends(FlintDeviceScannerFfos, _super);

  INTERVAL = 10 * 1000;

  function FlintDeviceScannerFfos() {
    FlintDeviceScannerFfos.__super__.constructor.apply(this, arguments);
  }

  FlintDeviceScannerFfos.prototype._createSSDP = function() {
    return new SSDPManagerFfos();
  };

  return FlintDeviceScannerFfos;
...
},{"../FlintDeviceScanner":2,"./SSDPManagerFfos":4}],4:[function(require,module,exports){
var SSDPManager, SSDPManagerFfos, SSDPResponderFfos,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
SSDPManagerFfos = (function(_super) {
  __extends(SSDPManagerFfos, _super);

  function SSDPManagerFfos() {
    SSDPManagerFfos.__super__.constructor.apply(this, arguments);
  }

  SSDPManagerFfos.prototype._createSSDPResponder = function(options) {
    return new SSDPResponderFfos(options);
  };

  SSDPManagerFfos.prototype._createXhr = function() {
    return new XMLHttpRequest({
      mozSystem: true
    });
  };

  return SSDPManagerFfos;
...
},{"../ssdp/SSDPManager":9,"./SSDPResponderFfos":5}],5:[function(require,module,exports){
var SSDPResponder, SSDPResponderFfos, UdpSocketFfos,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

SSDPResponder = require('../ssdp/SSDPResponder');

UdpSocketFfos = require('./UdpSocketFfos');

SSDPResponderFfos = (function(_super) {
  __extends(SSDPResponderFfos, _super);

  function SSDPResponderFfos(options) {
    this.options = options;
    SSDPResponderFfos.__super__.constructor.call(this, options);
  }

  SSDPResponderFfos.prototype._createUdpSocket = function(options) {
    return new UdpSocketFfos(options);
  };

  return SSDPResponderFfos;

})(SSDPResponder);

module.exports = SSDPResponderFfos;



},{"../ssdp/SSDPResponder":10,"./UdpSocketFfos":6}],6:[function(require,module,exports){
var UdpSocketFfos;

UdpSocketFfos = (function() {
  function UdpSocketFfos(options) {
    this.options = options;
  ...
  UdpSocketFfos.prototype._onMessage = function(data) {
    if (this.onPacket) {
      return this.onPacket(data);
    }
  };

  UdpSocketFfos.prototype.joinMulticastGroup = function(addr) {
    return this.socket.joinMulticastGroup(addr);
  };

  UdpSocketFfos.prototype.send = function(data, addr, port) {
    return this.socket.send(data, addr, port);
  };

  UdpSocketFfos.prototype.close = function() {
    return this.socket.close();
  };

  return UdpSocketFfos;
...
},{"./FlintDeviceScannerFfos":3}],8:[function(require,module,exports){
